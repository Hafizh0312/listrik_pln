    ...
    public function edit($id = null) {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $tarif_per_kwh_input = $this->input->post('tarif_per_kwh');
                $tarif_per_kwh = str_replace('.', '', $tarif_per_kwh_input); // Hilangkan titik ribuan
                $tarif_per_kwh = str_replace(',', '.', $tarif_per_kwh); // Ganti koma desimal ke titik
                $tarif_per_kwh = floatval($tarif_per_kwh); // Konversi ke float
